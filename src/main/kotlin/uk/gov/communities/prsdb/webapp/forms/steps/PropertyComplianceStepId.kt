...
enum class PropertyComplianceStepId(
    ...
    EPC("epc"),
    EpcNotAutoMatched("epc-not-automatched"),
    CheckAutoMatchedEpc("check-auto-matched-epc"),
    ...
    MeesExemptionCheck("mees-exemption-check"),
    MeesExemptionReason("mees-exemption-reason"),
    MeesExemptionConfirmation("mees-exemption-confirmation"),
    LowEnergyRating("low-energy-rating"),
