...
class RegisterPropertyController(
    ...
    fun getTaskList(model: Model): String {
        val registerTaskList = propertyRegistrationTaskList.getTaskListViewModels()
        val checkAndSubmitTaskList = checkAndSubmitPropertiesTaskList.getTaskListViewModels()
