...
class HasAnyJointLandlordsInvitedStepConfig : AbstractInternalStepConfig<AnyLandlordsInvited, LandlordInvitingState>() {
    override fun mode(state: LandlordInvitingState) =
...
) : JourneyStep.InternalStep<AnyLandlordsInvited, LandlordInvitingState>(stepConfig)
