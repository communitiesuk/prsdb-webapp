...
import uk.gov.communities.prsdb.webapp.controllers.LocalAuthorityCustomErrorController.Companion.LOCAL_AUTHORITY_ERROR_ROUTE

@PrsdbController
@RequestMapping(LOCAL_AUTHORITY_ERROR_ROUTE)
class LocalAuthorityCustomErrorController : CustomErrorController {
