...
// TODO PDJB-80: Implement Has MEES Exemption page
@JourneyFrameworkComponent
class HasMeesExemptionStepConfig : AbstractRequestableStepConfig<Complete, NoInputFormModel, JourneyState>() {
    override val formModelClass = NoInputFormModel::class

    override fun getStepSpecificContent(state: JourneyState) = mapOf("todoComment" to "TODO PDJB-80: Implement Has MEES Exemption page")
