...
data class SummaryListRowViewModel(
    ...
    val singleLineFormattedStringValue: SingleLineFormattedStringViewModel? = null,
) {
    ...
    companion object {
        ...
        fun forCheckYourAnswersPage(
            ...
            SummaryListRowViewModel(
                ...
                valueUrl = valueUrl,
                valueUrlOpensNewTab = valueUrlOpensNewTab,
                singleLineFormattedStringValue = singleLineFormattedStringValue,
            )
    }
}
...
data class SingleLineFormattedStringViewModel(
