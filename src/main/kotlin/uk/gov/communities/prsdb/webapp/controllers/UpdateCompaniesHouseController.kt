...
class UpdateCompaniesHouseController(
    ...
    companion object {
        const val UPDATE_COMPANIES_HOUSE_PATH_SEGMENT = "update-companies-house"
        const val UPDATE_COMPANIES_HOUSE_ROUTE =
            "/$LANDLORD_PATH_SEGMENT/$LANDLORD_DETAILS_PATH_SEGMENT/$UPDATE_COMPANIES_HOUSE_PATH_SEGMENT"
    }
}
