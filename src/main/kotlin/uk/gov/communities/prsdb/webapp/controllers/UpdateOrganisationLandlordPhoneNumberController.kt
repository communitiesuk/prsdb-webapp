...
class UpdateOrganisationLandlordPhoneNumberController(
    ...
    companion object {
        const val UPDATE_ORG_PHONE_NUMBER_PATH_SEGMENT = "update-organisation-phone-number"
        const val UPDATE_ORG_PHONE_NUMBER_ROUTE =
            "/$LANDLORD_PATH_SEGMENT/$LANDLORD_DETAILS_PATH_SEGMENT/$UPDATE_ORG_PHONE_NUMBER_PATH_SEGMENT"
    }
}
