...
class UpdateOrganisationMainContactController(
    ...
    companion object {
        const val UPDATE_ORG_MAIN_CONTACT_PATH_SEGMENT = "update-organisation-main-contact"
        const val UPDATE_ORG_MAIN_CONTACT_ROUTE =
            "/$LANDLORD_PATH_SEGMENT/$LANDLORD_DETAILS_PATH_SEGMENT/$UPDATE_ORG_MAIN_CONTACT_PATH_SEGMENT"
    }
}
