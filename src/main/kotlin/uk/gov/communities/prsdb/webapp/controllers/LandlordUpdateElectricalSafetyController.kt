...
import uk.gov.communities.prsdb.webapp.controllers.LandlordUpdateElectricalSafetyController.Companion.UPDATE_ELECTRICAL_SAFETY_ROUTE
...
class LandlordUpdateElectricalSafetyController(
    ...
    companion object {
        const val UPDATE_ELECTRICAL_SAFETY_ROUTE =
            "/$LANDLORD_PATH_SEGMENT/$PROPERTY_DETAILS_SEGMENT/{propertyOwnershipId}/update-electrical-safety"

        fun getUpdateElectricalSafetyFirstStepRoute(propertyOwnershipId: Long): String =
            UPDATE_ELECTRICAL_SAFETY_ROUTE.replace("{propertyOwnershipId}", propertyOwnershipId.toString()) +
