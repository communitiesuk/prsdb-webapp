...
class UpdateOrganisationLandlordAddressController(
    ...
    private fun checkUserIsOrganisationLandlord() {
        ...
        if (landlord !is OrganisationLandlord) {
            throw ResponseStatusException(HttpStatus.FORBIDDEN, "Only organisation landlords can update their organisation address")
        }
    }
    ...
    companion object {
        const val UPDATE_ORG_ADDRESS_ROUTE = "/$LANDLORD_PATH_SEGMENT/$LANDLORD_DETAILS_PATH_SEGMENT/update-organisation-address"
    }
}
