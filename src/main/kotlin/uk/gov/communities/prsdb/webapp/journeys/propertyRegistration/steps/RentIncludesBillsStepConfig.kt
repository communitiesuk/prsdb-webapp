...
class RentIncludesBillsStepConfig : AbstractRequestableStepConfig<YesOrNo, RentIncludesBillsFormModel, RentIncludesBillsState>() {
    ...
    override fun chooseTemplate(state: RentIncludesBillsState): String = "forms/rentIncludesBillsForm"

    override fun mode(state: RentIncludesBillsState): YesOrNo? =
...
) : RequestableStep<YesOrNo, RentIncludesBillsFormModel, RentIncludesBillsState>(stepConfig) {
    companion object {
