...
import uk.gov.communities.prsdb.webapp.journeys.IncompletePropertiesService
...
class IncompletePropertiesReminderTaskApplicationRunner(
    ...
    private fun incompletePropertiesReminderTaskLogic() {
        val incompleteProperties =
            incompletePropertiesService.getIncompletePropertiesOlderThanDays(INCOMPLETE_PROPERTY_AGE_WHEN_REMINDER_EMAIL_DUE_IN_DAYS)
        // TODO - PRSD-1030
