...
@Scope("prototype")
@PrsdbWebComponent
class TenantsStep : AbstractGenericStep<Complete, NumberOfPeopleFormModel, OccupiedJourneyState>() {
    ...
    override fun mode(state: OccupiedJourneyState) = formModel?.numberOfPeople?.let { Complete.COMPLETE }
