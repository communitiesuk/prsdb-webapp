...
class UpdateDateOfBirthStepConfig : AbstractRequestableStepConfig<Complete, DateOfBirthFormModel, JourneyState>() {
...
@JourneyFrameworkComponent
final class UpdateDateOfBirthStep(
    stepConfig: UpdateDateOfBirthStepConfig,
