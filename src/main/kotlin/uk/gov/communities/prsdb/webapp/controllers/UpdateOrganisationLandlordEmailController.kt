...
class UpdateOrganisationLandlordEmailController(
    ...
    companion object {
        const val UPDATE_ORG_EMAIL_PATH_SEGMENT = "update-organisation-email"
        const val UPDATE_ORG_EMAIL_ROUTE = "/$LANDLORD_PATH_SEGMENT/$LANDLORD_DETAILS_PATH_SEGMENT/$UPDATE_ORG_EMAIL_PATH_SEGMENT"
    }
}
