...
data class JointLandlordInvitationCancellationCancellerEmail(
    ...
    override val template = EmailTemplate.JOINT_LANDLORD_INVITATION_CANCELLATION_CANCELLER_EMAIL
