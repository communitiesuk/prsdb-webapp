...
class EpcRegistrationCyaSummaryRowsFactory(
    ...
    fun createEpcCardTitle(): String? = if (state.acceptedEpc != null) "checkEpcAnswers.epc.yourEpc" else null
    ...
    fun createEpcCardActions(): List<SummaryCardActionViewModel>? {
        ...
        return listOfNotNull(
            SummaryCardActionViewModel("checkEpcAnswers.epc.viewFullEpc", epcUrl, opensInNewTab = true),
    ...
    fun createEpcCardRows(): List<SummaryListRowViewModel>? {
        val epc = state.acceptedEpc ?: return null
        return listOf(
            SummaryListRowViewModel.forCheckYourAnswersPage("checkEpcAnswers.epc.address", epc.singleLineAddress, null as String?),
            SummaryListRowViewModel.forCheckYourAnswersPage("checkEpcAnswers.epc.energyRating", epc.energyRatingUppercase, null as String?),
            SummaryListRowViewModel.forCheckYourAnswersPage(
                "checkEpcAnswers.epc.expiryDate",
                epc.expiryDateAsJavaLocalDate,
                null as String?,
            ),
            SummaryListRowViewModel.forCheckYourAnswersPage(
                "checkEpcAnswers.epc.certificateNumber",
    ...
    fun createTenancyCheckRows(): List<SummaryListRowViewModel> {
        ...
        return listOf(
            SummaryListRowViewModel.forCheckYourAnswersPage(
                "checkEpcAnswers.epc.tenancyStartCheck",
    ...
    fun createAdditionalRows(): List<SummaryListRowViewModel> {
        ...
        return buildList {
            add(
                SummaryListRowViewModel.forCheckYourAnswersPage(
                    "checkEpcAnswers.epc.meesExemptionCheck",
            ...
            if (state.meesExemptionStep.isStepReachable) {
                add(
                    SummaryListRowViewModel.forCheckYourAnswersPage(
                        "checkEpcAnswers.epc.meesExemption",
    ...
    private fun getHasEpcRow(): SummaryListRowViewModel {
        val fieldValue =
            when {
                ...
                state.hasEpcStep.outcome == HasEpcMode.PROVIDE_LATER -> "checkEpcAnswers.hasEpc.provideEpcLaterUnoccupied"
                else -> "commonText.no"
            }
        return SummaryListRowViewModel.forCheckYourAnswersPage(
            "checkEpcAnswers.hasEpc.label",
            fieldValue,
