...
class LandlordRegistrationCheckAnswersPage(
    ...
    private fun getIdentityFormData(journeyData: JourneyData): List<FormSummaryDataModel> {
    ...
    private fun getAddressFormData(journeyData: JourneyData): List<FormSummaryDataModel> {
    ...
    private fun getLivesInUKFormData(livesInUK: Boolean): List<FormSummaryDataModel> =
        listOf(
            FormSummaryDataModel(
    ...
    private fun getInternationalAddressFormData(journeyData: JourneyData): List<FormSummaryDataModel> =
        listOf(
            FormSummaryDataModel(
