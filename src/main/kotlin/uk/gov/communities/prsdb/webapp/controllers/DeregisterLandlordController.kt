...
class DeregisterLandlordController(
        ...
        val formData =
            mutableMapOf(
                USER_HAS_REGISTERED_PROPERTIES_JOURNEY_DATA_KEY
                    to propertyOwnershipService.doesLandlordHaveRegisteredProperties(principal.name),
            )
    ...
    companion object {
        ...
        val LANDLORD_DEREGISTRATION_PATH = "$LANDLORD_DEREGISTRATION_ROUTE/${DeregisterLandlordStepId.AreYouSure.urlPathSegment}"
    }
}
