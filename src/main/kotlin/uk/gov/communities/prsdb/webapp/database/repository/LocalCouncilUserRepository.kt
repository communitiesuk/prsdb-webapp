...
interface LocalCouncilUserRepository : JpaRepository<LocalCouncilUser, Long> {
    ...
    @Suppress("ktlint:standard:function-naming")
    fun findAllByLocalCouncil_IdAndIsManagerTrue(localCouncilId: Int): List<LocalCouncilUser>
}
