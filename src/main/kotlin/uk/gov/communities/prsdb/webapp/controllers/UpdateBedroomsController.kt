...
class UpdateBedroomsController(
    ...
    companion object {
        const val UPDATE_BEDROOMS_ROUTE =
            "/$LANDLORD_PATH_SEGMENT/$PROPERTY_DETAILS_SEGMENT/{propertyOwnershipId}/update-bedrooms"

        fun getUpdateBedroomsRoute(propertyOwnershipId: Long): String =
            UPDATE_BEDROOMS_ROUTE.replace("{propertyOwnershipId}", propertyOwnershipId.toString())
    }
}
