...
INSERT INTO organisation_user (id, organisation_landlord_id, subject_identifier, name, email, created_date)
...
SELECT setval(pg_get_serial_sequence('organisation_user', 'id'), (SELECT MAX(id) FROM organisation_user));
