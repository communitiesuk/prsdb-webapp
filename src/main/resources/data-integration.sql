...
VALUES (1, true, 1, 1, 2, 9, 1, '2024-10-15 00:00:00+00', null, 1,
        1, null, null, 2, 1, null, 123.12, null, true, 'email@example.com', 9000000001, '2027-01-01'),
       (2, true, 0, 0, 0, 10, 2, '2025-01-15 00:00:00+00', null, 1,
        null, null, null, null, null, null, null, null, false, 'email@example.com', 9000000001, '2027-01-01'),
       ...
       (10, true, 1, 1, 2, 18, 10, '2026-02-27 00:00:00+00', null, 4,
        1, null, null, 2, 1, null, 123.12, 'End terrace', true, 'email@example.com', 9000000001, '2027-01-01'),
       ...
       (48, true, 0, 0, 0, 56, 7449182, '2026-04-14 00:00:00+00', null, 1,
        null, null, null, null, null, null, null, null, false, 'email@example.com', 9000000001, '2027-01-01') ON CONFLICT DO NOTHING;
...
SELECT 1200 + i, true, 1, 1, 2, 1200 + i, 9000001000 + i,
       ...
       TIMESTAMPTZ '2030-01-01 09:00:00+00' + make_interval(secs => (i - 1) * 86400), NULL, 1, 2, false, true, 'email@example.com', 9000000001, DATE '2027-01-01'
FROM generate_series(1, 101) AS s(i)
ON CONFLICT DO NOTHING;
...
SELECT 1600 + i, true, 1, 1, 2, 1600 + i, 9000002000 + i, created, created, NULL, 1, 2, false, true, 'email@example.com', 9000000001, DATE '2027-01-01'
FROM p
ON CONFLICT DO NOTHING;
