...
-- id=3 is occupied (license currently required), id=9 is unoccupied (license required once occupied)
UPDATE property_ownership SET license_provide_later = true WHERE id IN (3, 9);
