...
ALTER TABLE payment
    ADD CONSTRAINT uc_payment_property_ownership UNIQUE (property_ownership_id);

ALTER TABLE property
    ADD CONSTRAINT uc_property_address UNIQUE (address_id);

ALTER TABLE property_ownership
    ADD CONSTRAINT uc_propertyownership_payment UNIQUE (payment_id);
...
ALTER TABLE payment
    ADD CONSTRAINT FK_PAYMENT_PROPERTY_OWNERSHIP FOREIGN KEY (property_ownership_id) REFERENCES property_ownership (id);

ALTER TABLE property
    ADD CONSTRAINT FK_PROPERTY_ADDRESS FOREIGN KEY (address_id) REFERENCES address (id);

ALTER TABLE property_ownership
    ADD CONSTRAINT FK_PROPERTY_OWNERSHIP_PAYMENT FOREIGN KEY (payment_id) REFERENCES payment (id);
