...
VALUES ('28', 'ISLE OF MAN'),
       ...
       ('8130', 'ANTRIM AND NEWTOWNABBEY'),
       ('8131', 'ARMAGH BANBRIDGE AND CRAIGAVON'),
       ('8132', 'BELFAST'),
       ('8133', 'CAUSEWAY COAST AND GLENS'),
       ('8134', 'DERRY AND STRABANE'),
       ('8135', 'FERMANAGH AND OMAGH'),
       ('8136', 'LISBURN AND CASTLEREAGH'),
       ('8137', 'MID AND EAST ANTRIM'),
       ('8138', 'MID ULSTER'),
       ('8139', 'NEWRY MOURNE AND DOWN'),
       ('8140', 'NORTH DOWN AND ARDS'),
       ('8200', 'JERSEY'),
       ('8205', 'GUERNSEY'),
       ('9000', 'ORKNEY ISLANDS COUNCIL'),
       ('9010', 'SHETLAND ISLANDS COUNCIL'),
       ('9020', 'WESTERN ISLES COUNCIL (COMHAIRLE NAN EILEAN SIAR)'),
       ('9051', 'ABERDEEN CITY COUNCIL'),
       ('9052', 'ABERDEENSHIRE COUNCIL'),
       ('9053', 'ANGUS COUNCIL'),
       ('9054', 'ARGYLL & BUTE COUNCIL'),
