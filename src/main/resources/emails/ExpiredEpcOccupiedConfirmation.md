# A property's energy performance certificate (EPC) has expired
...
If you advertise this property or start a new tenancy, you must [get a new EPC (opens in new tab)](((epc guide url))).

[Add a new EPC to this property registration](((dashboard url)))
