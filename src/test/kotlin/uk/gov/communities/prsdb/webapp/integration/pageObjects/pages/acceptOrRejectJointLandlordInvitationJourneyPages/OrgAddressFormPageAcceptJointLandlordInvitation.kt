...
class OrgAddressFormPageAcceptJointLandlordInvitation(
    page: Page,
) : LookupAddressFormPage(
        page,
        "$ACCEPT_OR_REJECT_JOINT_LANDLORD_INVITATION_ROUTE/${OrgAddressTask.ROUTE_SEGMENT}/${LookupAddressStep.ROUTE_SEGMENT}",
    )
