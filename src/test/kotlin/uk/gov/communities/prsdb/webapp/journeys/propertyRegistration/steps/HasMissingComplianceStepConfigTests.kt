...
class HasMissingComplianceStepConfigTests {
    ...
    @Mock
    private lateinit var mockGasSafetyDetailsTask: GasSafetyDetailsTask
    ...
    inner class Mode {
        ...
        private fun setupGasCertMissing() {
            whenever(mockState.gasSafetyDetailsTask).thenReturn(mockGasSafetyDetailsTask)
            ...
            whenever(mockGasSafetyDetailsTask.hasGasSupplyStep).thenReturn(mockHasGasSupplyStep)
            whenever(mockGasSafetyDetailsTask.hasGasCertStep).thenReturn(mock<HasGasCertStep>())
            whenever(mockGasSafetyDetailsTask.getGasSafetyCertificateIsOutdated()).thenReturn(null)
        }
        ...
        private fun setupGasCertPresent() {
            ...
            whenever(mockGasSafetyDetailsTask.hasGasSupplyStep).thenReturn(mockHasGasSupplyStep)
            whenever(mockGasSafetyDetailsTask.hasGasCertStep).thenReturn(mock<HasGasCertStep>())
            whenever(mockGasSafetyDetailsTask.getGasSafetyCertificateIsOutdated()).thenReturn(false)
        }
        ...
        private fun setupElectricalCertMissing() {
            ...
            whenever(mockElectricalSafetyDetailsTask.hasElectricalCertStep).thenReturn(mock<HasElectricalCertStep>())
            whenever(mockElectricalSafetyDetailsTask.getElectricalCertificateIsOutdated()).thenReturn(null)
        }

        private fun setupElectricalCertPresent() {
            whenever(mockState.electricalSafetyDetailsTask).thenReturn(mockElectricalSafetyDetailsTask)
            whenever(mockElectricalSafetyDetailsTask.hasElectricalCertStep).thenReturn(mock<HasElectricalCertStep>())
            whenever(mockElectricalSafetyDetailsTask.getElectricalCertificateIsOutdated()).thenReturn(false)
        }
        ...
        private fun setupGasCertProvideLater() {
            ...
            whenever(mockGasSafetyDetailsTask.hasGasCertStep).thenReturn(mockHasGasCertStep)
        }
        ...
        private fun setupElectricalCertProvideLater() {
            ...
            whenever(mockElectricalSafetyDetailsTask.hasElectricalCertStep).thenReturn(mockHasElectricalCertStep)
        }
    ...
    inner class IsGasCertMissingOrExpired {
        ...
        fun `returns false when user chose provide this later`() {
            ...
            assertFalse(HasMissingComplianceStepConfig.isGasCertInvalid(mockState.gasSafetyDetailsTask))
        }
        ...
        fun `returns true when has gas supply and cert is missing`() {
            ...
            assertTrue(HasMissingComplianceStepConfig.isGasCertInvalid(mockState.gasSafetyDetailsTask))
        }
        ...
        fun `returns true when has gas supply and cert is outdated`() {
            ...
            whenever(mockGasSafetyDetailsTask.hasGasSupplyStep).thenReturn(mockHasGasSupplyStep)
            whenever(mockGasSafetyDetailsTask.hasGasCertStep).thenReturn(mock<HasGasCertStep>())
            whenever(mockGasSafetyDetailsTask.getGasSafetyCertificateIsOutdated()).thenReturn(true)
    ...
    inner class IsElectricalCertMissingOrExpired {
        ...
        fun `returns false when user chose provide this later`() {
            ...
            assertFalse(HasMissingComplianceStepConfig.isElectricalCertInvalid(mockState.electricalSafetyDetailsTask))
        }
        ...
        fun `returns true when cert is missing`() {
            ...
            assertTrue(HasMissingComplianceStepConfig.isElectricalCertInvalid(mockState.electricalSafetyDetailsTask))
        }
        ...
        fun `returns true when cert is outdated`() {
            whenever(mockState.electricalSafetyDetailsTask).thenReturn(mockElectricalSafetyDetailsTask)
            whenever(mockElectricalSafetyDetailsTask.hasElectricalCertStep).thenReturn(mock<HasElectricalCertStep>())
            whenever(mockElectricalSafetyDetailsTask.getElectricalCertificateIsOutdated()).thenReturn(true)
    ...
    inner class IsEpcMissingOrExpired {
        ...
        fun `returns false when user chose provide later`() {
            ...
            assertFalse(HasMissingComplianceStepConfig.isEpcInvalid(mockEpcDetailsTask))
        }
        ...
        fun `returns true when accepted epc present but expired and tenancy did not start before expiry`() {
            ...
            assertTrue(HasMissingComplianceStepConfig.isEpcInvalid(mockEpcDetailsTask))
        }
