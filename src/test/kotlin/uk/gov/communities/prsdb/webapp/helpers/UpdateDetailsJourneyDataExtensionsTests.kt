...
import uk.gov.communities.prsdb.webapp.helpers.UpdateLandlordDetailsJourneyDataHelper.Companion.getEmailUpdateIfPresent
...
class UpdateDetailsJourneyDataExtensionsTests {
    ...
    fun `getEmailUpdateIfPresent returns an optional email if the email page is in journeyData`() {
        ...
        val emailUpdate = getEmailUpdateIfPresent(testJourneyData)
