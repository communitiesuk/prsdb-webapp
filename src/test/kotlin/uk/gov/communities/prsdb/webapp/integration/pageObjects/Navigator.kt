...
import uk.gov.communities.prsdb.webapp.integration.PropertyStateSessionBuilder
...
class Navigator(
    ...
    fun skipToPropertyRegistrationSelectLocalAuthorityPage(): SelectLocalAuthorityFormPagePropertyRegistration {
        setJourneyStateInSession(
            PropertyStateSessionBuilder.beforePropertyRegistrationSelectLocalAuthority().build(),
        )
        navigateToPropertyRegistrationJourneyStep(RegisterPropertyStepId.LocalAuthority.urlPathSegment)
