...
@WebMvcTest(UpdateOrganisationLandlordAddressController::class)
class UpdateOrganisationLandlordAddressControllerTests(
    ...
    private val updateOrgAddressRoute =
        UpdateOrganisationLandlordAddressController.UPDATE_ORG_ADDRESS_ROUTE +
            "/${LookupAddressStep.ROUTE_SEGMENT}"

    @Test
    fun `getUpdateStep returns a redirect for unauthenticated user`() {
        mvc.get(updateOrgAddressRoute).andExpect {
