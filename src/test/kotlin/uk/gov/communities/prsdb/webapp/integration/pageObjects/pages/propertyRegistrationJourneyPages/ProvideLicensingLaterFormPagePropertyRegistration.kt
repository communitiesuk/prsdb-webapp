...
class ProvideLicensingLaterFormPagePropertyRegistration(
    page: Page,
) : BasePage(page, "${RegisterPropertyController.PROPERTY_REGISTRATION_ROUTE}/${ProvideLicensingLaterStep.ROUTE_SEGMENT}") {
