...
class EicrExemptionStepConfigTests {
    @Mock
    lateinit var mockJourneyState: JourneyState

    val routeSegment = EicrExemptionStep.ROUTE_SEGMENT
    ...
    private fun setupStepConfig(): EicrExemptionStepConfig {
        val stepConfig = EicrExemptionStepConfig()
