...
class HasGasCertOnlyStepConfigTests {
    @Mock
    lateinit var mockJourneyState: GasSafetyDetailState

    val routeSegment = HasGasCertOnlyStep.ROUTE_SEGMENT

    private fun setupStepConfig(): HasGasCertOnlyStepConfig {
        val stepConfig = HasGasCertOnlyStepConfig()
