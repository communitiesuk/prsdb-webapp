...
class PropertyRegistrationJourneyTests : IntegrationTestWithMutableData("data-local.sql") {
    ...
    fun `User can navigate the whole journey if pages are correctly filled in (select address, non-custom property type, selective license, occupied, compliance certificates uploaded)`(
        ...
        assertThat(selectAddressPage.form.sectionHeader).containsText("Section 1 of 2 — Add property details")
        // fill in and submit
        ...
        assertThat(propertyTypePage.form.sectionHeader).containsText("Section 1 of 2 — Add property details")
        // fill in and submit
        ...
        assertThat(ownershipTypePage.form.sectionHeader).containsText("Section 1 of 2 — Add property details")
        // fill in and submit
        ...
        assertThat(licensingTypePage.form.sectionHeader).containsText("Section 1 of 2 — Add property details")
        // fill in and submit
        ...
        assertThat(selectiveLicencePage.form.sectionHeader).containsText("Section 1 of 2 — Add property details")
        // fill in and submit
        ...
        assertThat(occupancyPage.form.sectionHeader).containsText("Section 1 of 2 — Add property details")
        // fill in and submit
        ...
        assertThat(householdsPage.sectionHeader).containsText("Section 1 of 2 — Add property details")
        // fill in and submit
        ...
        assertThat(peoplePage.sectionHeader).containsText("Section 1 of 2 — Add property details")
        // fill in and submit
        ...
        assertThat(bedroomsPage.form.sectionHeader).containsText("Section 1 of 2 — Add property details")
        // fill in and submit
        ...
        assertThat(rentIncludesBillsPage.form.sectionHeader).containsText("Section 1 of 2 — Add property details")
        // fill in and submit
        ...
        assertThat(billsIncludedPage.form.sectionHeader).containsText("Section 1 of 2 — Add property details")
        // fill in and submit
        ...
        assertThat(furnishedPage.form.sectionHeader).containsText("Section 1 of 2 — Add property details")
        // fill in and submit
        ...
        assertThat(rentFrequencyPage.sectionHeader).containsText("Section 1 of 2 — Add property details")
        // fill in and submit
        ...
        assertThat(rentAmountPage.sectionHeader).containsText("Section 1 of 2 — Add property details")
        // fill in and submit
        ...
        assertThat(hasJointLandlordsPage.sectionHeader).containsText("Section 1 of 2 — Add property details")
        ...
        assertThat(inviteJointLandlordPage.form.sectionHeader).containsText("Section 1 of 2 — Add property details")
        ...
        assertThat(checkJointLandlordsPage.sectionHeader).containsText("Section 1 of 2 — Add property details")
        ...
        assertThat(addAnotherPage.form.sectionHeader).containsText("Section 1 of 2 — Add property details")
        ...
        assertThat(hasGasSupplyPage.sectionHeader).containsText("Section 1 of 2 — Add property details")
        ...
        assertThat(hasGasCertPage.form.sectionHeader).containsText("Section 1 of 2 — Add property details")
        ...
        assertThat(gasCertIssueDatePage.form.sectionHeader).containsText("Section 1 of 2 — Add property details")
        ...
        assertThat(uploadGasCertPage.form.sectionHeader).containsText("Section 1 of 2 — Add property details")
        ...
        assertThat(checkGasCertUploadsPage.sectionHeader).containsText("Section 1 of 2 — Add property details")
        ...
        assertThat(checkGasSafetyAnswersPage.sectionHeader).containsText("Section 1 of 2 — Add property details")
        ...
        assertThat(hasElectricalCertPage.form.sectionHeader).containsText("Section 1 of 2 — Add property details")
        ...
        assertThat(electricalCertExpiryDatePage.form.sectionHeader).containsText("Section 1 of 2 — Add property details")
        ...
        assertThat(uploadElectricalCertPage.form.sectionHeader).containsText("Section 1 of 2 — Add property details")
        ...
        assertThat(checkElectricalCertUploadsPage.sectionHeader).containsText("Section 1 of 2 — Add property details")
        ...
        assertThat(checkElectricalSafetyAnswersPage.sectionHeader).containsText("Section 1 of 2 — Add property details")
        ...
        assertThat(confirmUprnMatchedEpcDetailsPage.sectionHeader).containsText("Section 1 of 2 — Add property details")
        confirmUprnMatchedEpcDetailsPage.submitNo()
        val hasEpcPage = assertPageIs(page, HasEpcFormPagePropertyRegistration::class)

        // Has EPC - render page
        assertThat(hasEpcPage.form.sectionHeader).containsText("Section 1 of 2 — Add property details")
        ...
        assertThat(findYourEpcPage.form.sectionHeader).containsText("Section 1 of 2 — Add property details")
        ...
        assertThat(confirmEpcDetailsPage.sectionHeader).containsText("Section 1 of 2 — Add property details")
        ...
        assertThat(checkEpcAnswersPage.sectionHeader).containsText("Section 1 of 2 — Add property details")
    ...
    fun `User can navigate the whole journey if pages are correctly filled in (manual address, custom property type, no license, unoccupied, no joint landlords, no certificates)`(
        ...
        assertThat(manualAddressPage.form.sectionHeader).containsText("Section 1 of 2 — Add property details")
        // fill in and submit
        ...
        assertThat(selectLocalCouncilPage.form.sectionHeader).containsText("Section 1 of 2 — Add property details")
        // fill in and submit
        ...
        assertThat(gasCertMissingPage.sectionHeader).containsText("Section 1 of 2 — Add property details")
        ...
        assertThat(electricalCertMissingPage.sectionHeader).containsText("Section 1 of 2 — Add property details")
        ...
        assertThat(isEpcRequiredPage.form.sectionHeader).containsText("Section 1 of 2 — Add property details")
        ...
        assertThat(epcMissingPage.sectionHeader).containsText("Section 1 of 2 — Add property details")
    ...
    fun `User can choose to provide compliance certificates later if their property is occupied`(page: Page) {
        ...
        assertThat(provideGasCertLaterPage.sectionHeader).containsText("Section 1 of 2 — Add property details")
        ...
        assertThat(provideElectricalCertLaterPage.sectionHeader).containsText("Section 1 of 2 — Add property details")
        assertThat(
        ...
        assertThat(provideEpcLaterPage.sectionHeader).containsText("Section 1 of 2 — Add property details")
    ...
    fun `User can complete the journey with expired compliance certificates for an occupied property (epc found by uprn)`(page: Page) {
        ...
        assertThat(gasCertExpiredPage.sectionHeader).containsText("Section 1 of 2 — Add property details")
        ...
        assertThat(electricalCertExpiredPage.sectionHeader).containsText("Section 1 of 2 — Add property details")
        ...
        assertThat(epcExpiryCheckPage.form.sectionHeader).containsText("Section 1 of 2 — Add property details")
        ...
        assertThat(epcExpiredPage.sectionHeader).containsText("Section 1 of 2 — Add property details")
    ...
    fun `The EPC task can be completed when FindYourEpc finds a superseded epc`(page: Page) {
        ...
        assertThat(epcSupersededPage.sectionHeader).containsText("Section 1 of 2 — Add property details")
    ...
    fun `The EPC task can be completed when FindYourEpc finds no epc and it is missing`(page: Page) {
        ...
        assertThat(epcNotFoundPage.sectionHeader).containsText("Section 1 of 2 — Add property details")
        ...
        assertThat(findYourEpcPageAgain.form.sectionHeader).containsText("Section 1 of 2 — Add property details")
        whenever(
            epcRegisterClient.getByRrn(NONEXISTENT_EPC_CERTIFICATE_NUMBER),
        ).thenReturn(MockEpcData.epcRegisterClientEpcNotFoundResponse)
    ...
    fun `User can navigate the MEES flow when they have a MEES exemption`(page: Page) {
        ...
        assertThat(hasMeesExemptionPage.sectionHeader).containsText("Section 1 of 2 — Add property details")
        ...
        assertThat(meesExemptionPage.form.sectionHeader).containsText("Section 1 of 2 — Add property details")
    ...
    fun `User can navigate the MEES flow when they do not have a MEES exemption`(page: Page) {
        ...
        assertThat(lowEnergyRatingPage.sectionHeader).containsText("Section 1 of 2 — Add property details")
    ...
    fun `User can navigate the EPC exemption flow`(page: Page) {
        ...
        assertThat(epcExemptionPage.form.sectionHeader).containsText("Section 1 of 2 — Add property details")
