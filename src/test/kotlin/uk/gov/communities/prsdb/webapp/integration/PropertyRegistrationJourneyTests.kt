...
class PropertyRegistrationJourneyTests : IntegrationTestWithMutableData("data-local.sql") {
    ...
    private val propertyRegistrationOldSectionHeader = "Section 1 of 2 — Add property details"
    ...
    @Test
    fun `Households page renders legacy content when skip tenancy journey disabled`() {
        ...
        assertThat(householdsPage.sectionHeader).containsText(propertyRegistrationOldSectionHeader)
    ...
    fun `User can navigate the whole journey if pages are correctly filled in (select address, non-custom property type, selective license, occupied, compliance certificates uploaded)`(
        ...
        assertThat(addressLookupPage.form.sectionHeader).containsText(propertyRegistrationOldSectionHeader)
        // fill in and submit
        ...
        assertThat(selectAddressPage.form.sectionHeader).containsText(propertyRegistrationOldSectionHeader)
        // fill in and submit
        ...
        assertThat(propertyTypePage.form.sectionHeader).containsText(propertyRegistrationOldSectionHeader)
        // fill in and submit
        ...
        assertThat(ownershipTypePage.form.sectionHeader).containsText(propertyRegistrationOldSectionHeader)
        // fill in and submit
        ...
        assertThat(licensingTypePage.form.sectionHeader).containsText(propertyRegistrationOldSectionHeader)
        // fill in and submit
        ...
        assertThat(selectiveLicencePage.form.sectionHeader).containsText(propertyRegistrationOldSectionHeader)
        // fill in and submit
        ...
        assertThat(occupancyPage.form.sectionHeader).containsText(propertyRegistrationOldSectionHeader)
        // fill in and submit
        ...
        assertThat(peoplePage.sectionHeader).containsText(propertyRegistrationOldSectionHeader)
        // fill in and submit
        ...
        assertThat(bedroomsPage.form.sectionHeader).containsText(propertyRegistrationOldSectionHeader)
        // fill in and submit
        ...
        assertThat(rentIncludesBillsPage.form.sectionHeader).containsText((propertyRegistrationOldSectionHeader))
        // fill in and submit
        ...
        assertThat(billsIncludedPage.form.sectionHeader).containsText(propertyRegistrationOldSectionHeader)
        // fill in and submit
        ...
        assertThat(furnishedPage.form.sectionHeader).containsText((propertyRegistrationOldSectionHeader))
        // fill in and submit
        ...
        assertThat(rentFrequencyPage.sectionHeader).containsText((propertyRegistrationOldSectionHeader))
        // fill in and submit
        ...
        assertThat(rentAmountPage.sectionHeader).containsText((propertyRegistrationOldSectionHeader))
        // fill in and submit
        ...
        assertThat(hasJointLandlordsPage.sectionHeader).containsText((propertyRegistrationOldSectionHeader))
        ...
        assertThat(inviteJointLandlordPage.form.sectionHeader).containsText((propertyRegistrationOldSectionHeader))
        ...
        assertThat(checkJointLandlordsPage.sectionHeader).containsText((propertyRegistrationOldSectionHeader))
        ...
        assertThat(addAnotherPage.form.sectionHeader).containsText((propertyRegistrationOldSectionHeader))
        ...
        assertThat(hasGasSupplyPage.sectionHeader).containsText((propertyRegistrationOldSectionHeader))
        ...
        assertThat(hasGasCertPage.form.sectionHeader).containsText((propertyRegistrationOldSectionHeader))
        ...
        assertThat(gasCertIssueDatePage.form.sectionHeader).containsText((propertyRegistrationOldSectionHeader))
        ...
        assertThat(uploadGasCertPage.form.sectionHeader).containsText((propertyRegistrationOldSectionHeader))
        ...
        assertThat(checkGasCertUploadsPage.sectionHeader).containsText((propertyRegistrationOldSectionHeader))
        ...
        assertThat(checkGasSafetyAnswersPage.sectionHeader).containsText((propertyRegistrationOldSectionHeader))
        ...
        assertThat(hasElectricalCertPage.form.sectionHeader).containsText((propertyRegistrationOldSectionHeader))
        ...
        assertThat(electricalCertExpiryDatePage.form.sectionHeader).containsText((propertyRegistrationOldSectionHeader))
        ...
        assertThat(uploadElectricalCertPage.form.sectionHeader).containsText((propertyRegistrationOldSectionHeader))
        ...
        assertThat(checkElectricalCertUploadsPage.sectionHeader).containsText((propertyRegistrationOldSectionHeader))
        ...
        assertThat(checkElectricalSafetyAnswersPage.sectionHeader).containsText((propertyRegistrationOldSectionHeader))
        ...
        assertThat(confirmUprnMatchedEpcDetailsPage.sectionHeader).containsText((propertyRegistrationOldSectionHeader))
        confirmUprnMatchedEpcDetailsPage.submitNo()
        val hasEpcPage = assertPageIs(page, HasEpcFormPagePropertyRegistration::class)

        // Has EPC - render page
        assertThat(hasEpcPage.form.sectionHeader).containsText((propertyRegistrationOldSectionHeader))
        ...
        assertThat(findYourEpcPage.form.sectionHeader).containsText((propertyRegistrationOldSectionHeader))
        ...
        assertThat(confirmEpcDetailsPage.sectionHeader).containsText((propertyRegistrationOldSectionHeader))
        ...
        assertThat(checkEpcAnswersPage.sectionHeader).containsText((propertyRegistrationOldSectionHeader))
    ...
    fun `User can navigate the whole journey if pages are correctly filled in (manual address, custom property type, no license, unoccupied, no joint landlords, no certificates)`(
        ...
        assertThat(manualAddressPage.form.sectionHeader).containsText((propertyRegistrationOldSectionHeader))
        // fill in and submit
        ...
        assertThat(selectLocalCouncilPage.form.sectionHeader).containsText((propertyRegistrationOldSectionHeader))
        // fill in and submit
        ...
        assertThat(gasCertMissingPage.sectionHeader).containsText((propertyRegistrationOldSectionHeader))
        ...
        assertThat(electricalCertMissingPage.sectionHeader).containsText((propertyRegistrationOldSectionHeader))
        ...
        assertThat(isEpcRequiredPage.form.sectionHeader).containsText((propertyRegistrationOldSectionHeader))
        ...
        assertThat(epcMissingPage.sectionHeader).containsText((propertyRegistrationOldSectionHeader))
    ...
    fun `User can choose to provide compliance certificates later if their property is occupied`(page: Page) {
        ...
        assertThat(provideGasCertLaterPage.sectionHeader).containsText((propertyRegistrationOldSectionHeader))
        ...
        assertThat(provideElectricalCertLaterPage.sectionHeader).containsText((propertyRegistrationOldSectionHeader))
        assertThat(
        ...
        assertThat(provideEpcLaterPage.sectionHeader).containsText((propertyRegistrationOldSectionHeader))
    ...
    fun `User can complete the journey with expired compliance certificates for an occupied property (epc found by uprn)`(page: Page) {
        ...
        assertThat(gasCertExpiredPage.sectionHeader).containsText((propertyRegistrationOldSectionHeader))
        ...
        assertThat(electricalCertExpiredPage.sectionHeader).containsText((propertyRegistrationOldSectionHeader))
        ...
        assertThat(epcExpiryCheckPage.form.sectionHeader).containsText((propertyRegistrationOldSectionHeader))
        ...
        assertThat(epcExpiredPage.sectionHeader).containsText((propertyRegistrationOldSectionHeader))
    ...
    fun `The EPC task can be completed when FindYourEpc finds a superseded epc`(page: Page) {
        ...
        assertThat(epcSupersededPage.sectionHeader).containsText((propertyRegistrationOldSectionHeader))
    ...
    fun `The EPC task can be completed when FindYourEpc finds no epc and it is missing`(page: Page) {
        ...
        assertThat(epcNotFoundPage.sectionHeader).containsText((propertyRegistrationOldSectionHeader))
        ...
        assertThat(findYourEpcPageAgain.form.sectionHeader).containsText((propertyRegistrationOldSectionHeader))
        whenever(
            epcRegisterClient.getByRrn(NONEXISTENT_EPC_CERTIFICATE_NUMBER),
        ).thenReturn(MockEpcData.epcRegisterClientEpcNotFoundResponse)
    ...
    fun `User can navigate the MEES flow when they have a MEES exemption`(page: Page) {
        ...
        assertThat(hasMeesExemptionPage.sectionHeader).containsText((propertyRegistrationOldSectionHeader))
        ...
        assertThat(meesExemptionPage.form.sectionHeader).containsText((propertyRegistrationOldSectionHeader))
    ...
    fun `User can navigate the MEES flow when they do not have a MEES exemption`(page: Page) {
        ...
        assertThat(lowEnergyRatingPage.sectionHeader).containsText((propertyRegistrationOldSectionHeader))
    ...
    fun `User can navigate the EPC exemption flow`(page: Page) {
        ...
        assertThat(epcExemptionPage.form.sectionHeader).containsText((propertyRegistrationOldSectionHeader))
