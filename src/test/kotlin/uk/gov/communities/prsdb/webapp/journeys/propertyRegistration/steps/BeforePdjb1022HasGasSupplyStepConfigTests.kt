...
class BeforePdjb1022HasGasSupplyStepConfigTests {
    @Mock
    lateinit var mockJourneyState: JourneyState

    val routeSegment = BeforePdjb1022HasGasSupplyStep.ROUTE_SEGMENT
    ...
    private fun setupStepConfig(): BeforePdjb1022HasGasSupplyStepConfig {
        val stepConfig = BeforePdjb1022HasGasSupplyStepConfig()
