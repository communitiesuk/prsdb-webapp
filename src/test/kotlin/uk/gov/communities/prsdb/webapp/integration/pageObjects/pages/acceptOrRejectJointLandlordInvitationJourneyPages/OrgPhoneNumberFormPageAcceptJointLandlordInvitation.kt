...
class OrgPhoneNumberFormPageAcceptJointLandlordInvitation(
    page: Page,
) : PhoneNumberFormPage(page, "$ACCEPT_OR_REJECT_JOINT_LANDLORD_INVITATION_ROUTE/${OrgPhoneNumberStep.ROUTE_SEGMENT}")
