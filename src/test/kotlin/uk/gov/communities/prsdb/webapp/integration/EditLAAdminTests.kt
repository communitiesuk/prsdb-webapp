...
class EditLAAdminTests : IntegrationTestWithMutableData("data-la-admin-users-and-invitations-user-is-system-operator.sql") {
    @Test
    fun `back link goes to manage admin users page`(page: Page) {
        val editAdminsPage = navigator.goToEditAdminsPage(1)
        editAdminsPage.backLink.clickAndWait()
