...
class PropertyOwnershipServiceTests {
    ...
    fun `createPropertyOwnership creates a property ownership`() {
        ...
        whenever(mockRegistrationNumberService.createRegistrationNumber(RegistrationNumberType.PROPERTY)).thenReturn(registrationNumber)
        whenever(mockPropertyOwnershipRepository.save(any(PropertyOwnership::class.java))).thenReturn(expectedPropertyOwnership)
