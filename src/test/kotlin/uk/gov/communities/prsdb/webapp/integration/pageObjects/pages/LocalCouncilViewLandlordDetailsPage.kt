...
class LocalCouncilViewLandlordDetailsPage(
    page: Page,
    urlArguments: Map<String, String>,
) : LandlordDetailsBasePage(page, LandlordDetailsController.getLandlordDetailsForLocalCouncilUserPath(urlArguments["id"]!!.toLong())) {
