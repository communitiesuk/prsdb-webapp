...
INSERT INTO property_ownership (id, is_active, ownership_type, current_num_households, current_num_tenants,
                                ...
                                marked_joint_landlord, is_occupied, correspondence_email, correspondence_address_id, renewal_date)
VALUES (1, true, 1, 0, 0, 3, 2, 1, null, null, false, false, 'email@example.com', 1, '2027-01-01'),
       (2, true, 1, 1, 2, 4, 3, 1, 1, 123.12, true, true, 'email@example.com', 1, '2027-01-01');
