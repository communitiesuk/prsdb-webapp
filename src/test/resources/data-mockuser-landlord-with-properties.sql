...
INSERT INTO property_compliance (id, property_ownership_id, gas_safety_upload_id, gas_safety_cert_issue_date, gas_safety_cert_engineer_num, has_gas_supply, eicr_exemption_reason, epc_exemption_reason)
VALUES (1, 1,1, current_date, '1234567', true, 0, 0),
       (2, 2, null, current_date, '1234567', true, 0, 0),
       (3, 3, null, current_date, '1234567', true, 0, 0);
