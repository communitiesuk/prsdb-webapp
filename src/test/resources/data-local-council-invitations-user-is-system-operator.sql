...
INSERT INTO local_council_invitation (invited_email, inviting_council_id, token, invited_as_admin)
VALUES ('invited.user@example.com', 1, 'e98583f2-91b1-46ed-afb1-6cfcbaf97e63', false),
       ...
       ('y.adminuser@example.com', 1, 'e98583f2-91b1-46ed-afb1-6cfcbaf97e65', true),
       ('x.adminuser@example.com', 1, 'e98583f2-91b1-46ed-afb1-6cfcbaf97e66', true);
