...
export async function createCompletionRateCSV() {
    ...
    const llRegRate = (llRegStart === 0 || llRegStart === null) ? null : (llRegConf === 0 || llRegConf === null) ? 0 : ((llRegConf / llRegStart) * 100).toFixed(2);
    ...
    const propRegRate = (propRegStart === 0 || propRegStart === null) ? null : (propRegConf === 0 || propRegConf === null) ? 0 : ((propRegConf / propRegStart) * 100).toFixed(2);
    ...
    const complianceRate = (complianceStart === 0 || complianceStart === null) ? null : (complianceConf === 0 || complianceConf === null) ? 0 : ((complianceConf / complianceStart) * 100).toFixed(2);
    ...
    const lcUserRate = (lcUserStart === 0 || lcUserStart === null) ? null : (lcUserConf === 0 || lcUserConf === null) ? 0 : ((lcUserConf / lcUserStart) * 100).toFixed(2);
